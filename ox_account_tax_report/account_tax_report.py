...
class AccountTaxGroupExtended(models.Model):
    _inherit='account.tax'

    tax_group_id = fields.Many2many('account.tax.group', 'account_tax_group_rel', 'tax_id', 'group_id', string='Grupo de impuestos')
